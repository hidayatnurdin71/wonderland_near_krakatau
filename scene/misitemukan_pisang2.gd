extends Sprite
var dialogPath = "user://ketemupohon_pisang2.json"
export(float) var textSpeed = 0.05
var dialog
var _file ="ketemupohon_pisang2.json"
var file
var phraseNum = 0
var finished = false
var json_data
...
#		Global.coins = Global.reward +Global.coins
		...
		Autoload.emit_signal("misi4")
		Global.coins = Global.reward +Global.coins
		DataManager.data["Objects"]["pisang_ditemukan2"]=["sudah"]
