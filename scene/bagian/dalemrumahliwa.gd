...
func _ready():
	if DataManager.data["Objects"].has("character_dalem"):
		character.global_position = DataManager.data["Objects"]["character_dalem"]
...
func _process(delta):
	DataManager.data["Objects"]["character_dalem"] = character.global_position
